import fs from 'fs';
let c = fs.readFileSync('src/components/admin/AdminDashboard.tsx', 'utf8');
const oldText = `{/* Tab 5: Analytics */}
      {activeTab === 'analytics' && (
...
fs.writeFileSync('src/components/admin/AdminDashboard.tsx', c);
